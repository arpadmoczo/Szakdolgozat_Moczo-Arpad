...
<script>
    function blankcheck() {
        var errormsg = "<b><span style='color:red'>Kérem, adja meg a nevét és töltse ki a visszajelzés mezőt!</span></b>";
...
<article class="col-8 col-t-12">
	<h3 id="valalkozas">A vállalatról</h3>
	...
	<figure class="col-5 col-t-6">
		<img src="img/rolunk.jpeg" alt="Minta fotó" onerror="" width="600">
		<figcaption id="errorMsg"></figcaption>
	</figure>
	
	<h3 id="missvis">Missziónk, víziónk</h3>
	<p class="bekezdes">
	...
	<form  action="check_feedback.php" onSubmit="return blankcheck()" method="POST" id="feedback_form">
		<table class="col-12 col-t-12">
			...
			<tr>
				...
				<td class="col-9 col-t-9"><input type="text" name="feedback" value="Írja ide visszajelzését..." style="width: 100%; line-height: 5em"></td>
			</tr>
			<tr>
	...
	?>
				...
				<tr>
					<td class="col-3 col-t-3"><hr><?php echo $row["name"]; ?></td>
					<td class="col-9 col-t-9"><hr><?php echo $row["feedback"]; ?></td>
				</tr>
