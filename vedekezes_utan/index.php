...
<body>
	...
	<article class="col-8 col-t-12">
		<h3>A MoneyTrans világvezető neobank</h3>
		...
		<figure class="col-5 col-t-6">
			<img src="img/fooldal1.jpg" alt="Első mintakép." width="600">
			<figcaption>Mintakép 1.</figcaption>
		</figure>
		...
		<figure class="col-5 col-t-6">
			<img src="img/fooldal2.jpg" alt="Második mintakép." width="600">
			<figcaption>Mintakép 2.</figcaption>
		</figure>
		...
		<h3>Megbízható szolgáltatást nyújtunk</h3>
		<p  class="col-12 col-t-12">
